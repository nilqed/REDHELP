...
\begin{Command}[algebraic]{ALGEBRAIC}
\index{evaluation}
...
\begin{Declaration}[antisymmetric]{ANTISYMMETRIC}
...
\begin{Declaration}[depend]{DEPEND}
\index{dependency}
...
\begin{Declaration}[integer]{INTEGER}
...
\begin{Declaration}[linear]{LINEAR}
\index{operator}
...
\begin{Declaration}[linelength]{LINELENGTH}
\index{output}
...
\begin{Declaration}[listargp]{LISTARGP}
...
\begin{Declaration}[noncom]{NONCOM}
...
\begin{Declaration}[operator]{OPERATOR}
...
\begin{Declaration}[precedence]{PRECEDENCE}
\index{operator}
...
\begin{Declaration}[precision]{PRECISION}
...
\begin{Declaration}[print_precision]{PRINT\_PRECISION}
...
\begin{Declaration}[scalar]{SCALAR}
...
\begin{Declaration}[scientific_notation]{SCIENTIFIC\_NOTATION}
\index{output}\index{floating point}\index{rounded}
\begin{Syntax}
...
\begin{Declaration}[symmetric]{SYMMETRIC}
\index{operator}
...
\begin{Declaration}[varname]{VARNAME}
