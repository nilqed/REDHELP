...
\begin{Introduction}[arithmetic\_operations]{ARITHMETIC\_OPERATIONS}
...
\begin{Operator}[]deg2dms{DEG2DMS}
...
\begin{Operator}[deg2rad]{DEG2RAD}
\index{degrees}\index{radians}
...
\begin{Operator}[difference]{DIFFERENCE}
...
\begin{Operator}[dms2deg]{DMS2DEG}
\index{degrees}\index{radians}
...
\begin{Operator}[dms2rad]{DMS2RAD}
\index{degrees}\index{radians}
...
\begin{Operator}[nextprime]{NEXTPRIME}
\index{prime number}
\begin{Syntax}
...
\begin{Operator}[quotient]{QUOTIENT}
...
\begin{Operator}[rad2deg]{RAD2DEG}
\index{degrees}\index{radians}
\begin{Syntax}
...
\begin{Operator}[rad2dms]{RAD2DMS}
\index{degrees}\index{radians}
...
\begin{Operator}[remainder]{REMAINDER}
\index{polynomial}
