...
\begin{Operator}[replace]{\Rightarrow}
...
\begin{Operator}[caret]{\textasciicircum}
The \name{^} operator is a prefix or infix binary exponentiation operator.
It is equivalent to \nameref{power} or **.
...
\begin{Operator}[tilde]{\textasciitilde}
...
\begin{Operator}[greaterp]{GREATERP}
...
\begin{Command}[procedure]{PROCEDURE}
...
\begin{Type}[free variable]{Free Variable}
\index{variable}
...
\begin{Type}[optional free variable]{Optional Free Variable}
\index{variable}
